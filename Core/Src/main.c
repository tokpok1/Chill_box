...
double map(uint16_t x, uint16_t value_x_1, uint16_t value_x_2, uint16_t value_y_1, uint16_t value_y_2)
{
	double m = (double)(value_y_2 - value_y_1) / (value_x_2 - value_x_1);
